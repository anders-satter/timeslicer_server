...
class TimeSliceSpec extends Specification with Mockito {
  ...
  "TimeSlice" should {
    "return start" in {
      timeslice1.startdate == "2015-08-11" must beTrue

      timeslice1.starttime == "09:30" must beTrue
    }
    "return end" in {
    	timeslice1.enddate == "2015-08-11" must beTrue
      timeslice1.endtime == "10:28" must beTrue
    }
